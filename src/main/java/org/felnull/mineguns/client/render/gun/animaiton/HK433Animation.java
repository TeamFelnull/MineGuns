...
public class HK433Animation extends GunAnimation {
	...
	public void renderRightHand(ItemStack stack, float holdpar, float shotcooldwonpar) {
		...
		RenderHelper.renderGunItem(stack, TransformType.FIRST_PERSON_RIGHT_HAND, 3, 3, 3, 0.11f, -0.24f, -0.48f, 0.02f,
	...
	public void renderLeftHand(ItemStack stack, float holdpar, float shotcooldwonpar) {
		...
		RenderHelper.renderGunHand(Hand.MAIN_HAND, -0.79999983f, 0.19999945f, -0.7700001f, -0.3999999f, -0.23000002f,
				0.2f, holdpar, 0.5f, -0.09999996f, -0.19999993f, 0.0f, 0.0f, 0.09999999f, shotcooldwonpar, 0.0f, 0.0f,
				0.0f, 0.01f, 0.0f, 0.0f);
		RenderHelper.renderGunItem(stack, TransformType.FIRST_PERSON_LEFT_HAND, 3, 3, 3, 0.07837011f, -0.24f, -0.48f, 0.02f,
